...
public class ConfiguracioWeb implements WebMvcConfigurer {
    ...
    */
    ...
    public void addViewControllers(ViewControllerRegistry registre) {
        registre.addViewController("/paginasVentas/ventasAdministrador/crearBocadilloDeLaSemana").setViewName("index"); //Mostrem la pàgina incial que reanomenen com a index, quan encara no ens hem autenticat
